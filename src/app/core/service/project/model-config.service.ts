...
export class ModelConfigService {
  ...
  getCVMissionData(id: string) {
    return this.httpClient.get<MissionData | { msg: string }>(`${BE_URL}/cv/config/get-mission-data/${id}`, {
      headers: {
        rltoken: this.getToken()
      }
    });
   ...
   * @memberof ModelConfigService
   */
  endCVMission(id: string) {
    return this.httpClient.post<{ msg: string }>(
      `${BE_URL}/cv/config/end-mission`,
      {
        id
      },
      { headers: { rltoken: this.getToken() } }
  ...
  getRLMissionData(id: string) {
    return this.httpClient.get<MissionData[] | { msg: string }>(`${BE_URL}/rl/config/get-mission-data/${id}`, {
      headers: {
        rltoken: this.getToken()
      }
    });
   ...
   * @memberof ModelConfigService
   */
  endRLMission(id: string) {
    return this.httpClient.post<{ msg: string }>(
      `${BE_URL}/rl/config/end-mission`,
      {
        id
      },
      { headers: { rltoken: this.getToken() } }
