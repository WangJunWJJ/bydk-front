...
import { IMission, IRLConfig, ImportDataTypeEnum, MissionStatusEnum, MissionTypeEnum } from 'src/app/core/service/project/core';
import { ModelCompUploadComponent } from '../../components/upload-comp/upload.component';
import { ModelRLConfigEditComponent } from '../config/edit/edit.component';
import { ModelRLPyClusterMonitorComponent } from './view/view.component';
import { ModelRLConfigViewComponent } from '../config/view/view.component';
import { ModelRLResultViewComponent } from '../result/view/view.component';
@Component({
  selector: 'app-model-rl-monitor',
  templateUrl: './monitor.component.html',
  styleUrls: ['./monitor.component.less']
})
export class ModelRLMonitorComponent implements OnInit, OnDestroy {
      ...
      buttons: [
        {
          ...
          click: (record: IMission<IRLConfig>) => {
            this.modelConfigService.getRLMonitorUrl(record.id).subscribe(url => {
              this.modal
                .createStatic(
        ...
        },
        {
          ...
          click: (record: IMission<IRLConfig>) => {
            this.modalSrv.confirm({
              ...
              nzOkDanger: true,
              nzOnOk: () => {
                this.modelConfigService.endRLMission(record.id).subscribe(
                  newMission => {
                    this.searchStream$.next({ ...this.searchStream$.value });
