...
import { ClusterLogTypeEnum, IMission, IRLConfig, ISlaveData, MissionData, PyClusterResponse } from 'src/app/core/service/project/core';
...
export class ModelRLPyClusterMonitorComponent implements OnInit, OnDestroy, AfterViewInit {
  record!: {
    id: string;
